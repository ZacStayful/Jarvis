...
> The 16 rules that govern every n8n workflow build. Non-negotiable — derived from real trial-and-error. Cite the rule number whenever a decision references one (e.g. "Rule 8 says echo the challenge").
>
