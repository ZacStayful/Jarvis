// ════════════════════════════════════════════════════════════════════════
// airbtics.ts — Part 1 of 4 (lines 1-450)
// Source file split for Drive upload size limits. Concatenate all 4 parts
// in order to reconstruct the original 1804-line file.
// ════════════════════════════════════════════════════════════════════════
...
async function fetchReportAll(
  ...
  while (Date.now() - startTime < REPORT_POLL_MAX_MS) {
    ...
    if (!readRes.ok) {
// ════════════════════════════════════════════════════════════════════════
// airbtics.ts — Part 2 of 4 (lines 451-900)
// ════════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════════
// airbtics.ts — Part 3 of 4 (lines 901-1350)
// ════════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════════
// airbtics.ts — Part 4 of 4 (lines 1351-1804) — END
// ════════════════════════════════════════════════════════════════════════
